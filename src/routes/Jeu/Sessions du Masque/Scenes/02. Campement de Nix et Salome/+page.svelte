<script lang="ts">
  ...
  tocHeadings.set([
      ...
      {
          "id": "lpreuve-des-enfants",
          "text": "L'épreuve des Enfants",
          "level": 3
      },
      {
          "id": "la-gemme-maudite",
          "text": "La Gemme Maudite",
          "level": 3
      },
      {
          "id": "les-murmures-sous-les-racines",
          "text": "Les Murmures Sous les Racines",
          "level": 3
      },
      {
...
<svelte:head>
  <title>02. Campement de Nix et Salomé</title>
</svelte:head>

<article class="md-page">
  <header class="md-header">
    <h1>02. Campement de Nix et Salomé</h1>
  </header>
...
{#snippet rencontres()}
	...
	{@html renderMarkdown("\n|  Nom   | Rôle                  |  Race  | Sexe  | Age |     Personnalité     |   Accent    |   Equipement    |\n| :----: | --------------------- | :----: | :---: | :-: | :------------------: | :---------: | :-------------: |\n|        | Cuisinier             | Humain | Homme | 40  |                      | Marseillais |                 |\n|        | Servante              | Humain | Femme | 25  |                      |      -      |                 |\n|  Nix   | Mercenaire<br>Paladin | Humain | Femme | 30  | Joviale<br>Camioneur |      -      |  <img src=\"%%BASE%%/2-Nix.jpg\" alt=\"2-Nix.jpg\" class=\"wiki-image\" />   |\n| Salomé | Prêtresse<br>Paladin  | Humain | Femme | 30  | Directe<br>Factuelle |      -      | <img src=\"%%BASE%%/2-Salom%C3%A9.jpg\" alt=\"2-Salomé.jpg\" class=\"wiki-image\" /> |\n")}
...
{#snippet intrigues()}
	...
	{@render lesMurmuresSousLesRacines()}
	</section>
{/snippet}
