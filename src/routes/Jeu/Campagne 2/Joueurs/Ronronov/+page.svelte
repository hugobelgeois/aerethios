...
{#snippet notes()}
	...
	{@html renderMarkdown("\nCalico (Meowscular Chef MHW) de Kothula\nAncien prêtre, il a été réquisitionné par l'armée pour soigner les arrières troupes, avant de devenir cuisinier\nIl connait déjà Diego qui est un habitué de son restaurant")}
