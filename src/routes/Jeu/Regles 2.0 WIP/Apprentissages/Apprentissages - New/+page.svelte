...
{#snippet artisanat__New()}
	...
	{@html renderMarkdown("\n| Compétence     | Description                                                            |\n| -------------- | ---------------------------------------------------------------------- |\n| **Artificier** | Fabrication d'armes à feu, d'automations, de mécanismes et d'explosifs |\n| **Bijoutier**  | Fabrication de bijoux ou catalyseurs de magie                          |\n| **Enchanteur** | Création et application de capacités uniques                           |\n| **Forgeron**   | Fabrication d'armes (sauf armes à feu) et d’armures                    |\n")}
...
{#snippet fabrication()}
	...
	{@html renderMarkdown("> `1d20 + Niveau du Métier + Aide(Niveau de métier du personnage qui aide / 2)`\n")}
	{@render recette()}
	{@render mcanique()}
	{@render ressources()}
	{@render ustensiles()}
