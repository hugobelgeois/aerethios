...
{#snippet prcision()}
	...
	{@html renderMarkdown("> La taille de la cible et les obstacles entre elle et le tireur altèrent l'AC de la cible.\n\n| Taille | Minuscule | Petit | Normal | Grand | Géant | Gargantuesque |\n| ------ | --------- | ----- | ------ | ----- | ----- | ------------- |\n| **AC** | +4        | +2    | 0      | -2    | -4    | -8            |\n\n| Couvert | Léger | Moyen | Total      |\n| ------- | ----- | ----- | ---------- |\n| **AC**  | +2    | +4    | Impossible |\n")}
