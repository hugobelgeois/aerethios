...
{#snippet difficultParIngrdient()}
	<section>
		<h3 id="difficult-par-ingrdient">Difficulté par ingrédient</h3>
...
{#snippet difficultParEmplacement()}
	<section>
		<h3 id="difficult-par-emplacement">Difficulté par emplacement</h3>
...
{#snippet prixIndicatifsDesIngrdientsPa()}
	<section>
		<h3 id="prix-indicatifs-des-ingrdients-pa">Prix indicatifs des ingrédients (pa)</h3>
