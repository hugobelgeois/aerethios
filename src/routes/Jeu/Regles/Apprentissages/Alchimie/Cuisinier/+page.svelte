...
{#snippet ingrdients()}
	<section>
		<h2 id="ingrdients">{@html applyBase("Ingrédients")}</h2>
...
{#snippet viandes_BonusPhysiques()}
	<section>
		<h3 id="viandes--bonus-physiques">{@html applyBase("**Viandes** — bonus physiques")}</h3>
...
{#snippet accompagnements_BonusMagiques()}
	<section>
		<h3 id="accompagnements--bonus-magiques">{@html applyBase("**Accompagnements** — bonus magiques")}</h3>
...
{#snippet toucheDuChef()}
	<section>
		<h2 id="touche-du-chef">{@html applyBase("Touche du Chef")}</h2>
