...
{#snippet statistiquesDeLinvocation()}
	<section>
		<h3 id="statistiques-de-linvocation">{@html applyBase("Statistiques de l'invocation")}</h3>
...
{#snippet typesDinvocations()}
	<section>
		<h2 id="types-dinvocations">{@html applyBase("Types d'invocations")}</h2>
...
{#snippet force()}
	<section>
		<h3 id="force">{@html applyBase("Force")}</h3>
...
{#snippet agilit()}
	<section>
		<h3 id="agilit">{@html applyBase("Agilité")}</h3>
...
{#snippet magicien()}
	<section>
		<h3 id="magicien">{@html applyBase("Magicien")}</h3>
...
{#snippet dureEtStabilit()}
	<section>
		<h3 id="dure-et-stabilit">{@html applyBase("Durée et stabilité")}</h3>
