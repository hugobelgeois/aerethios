<script lang="ts">
  ...
  tocHeadings.set([
      ...
      {
          "id": "prix-du-march-pour-enchanter-po",
          "text": "Prix du marché pour enchanter (po)",
          "level": 2
      },
      {
          "id": "kothula-wip",
...
<article class="md-page">
  ...
  <div class="markdown-rendered">
		...
		{@render composants()}
		{@render prixDuMarchPourEnchanterPo()}
		{@render kothulaWip()}
		{@render nirina()}
		{@render ovliin()}
		{@render suraja()}
...
{#snippet prixDuMarchPourEnchanterPo()}
	<section>
		<h2 id="prix-du-march-pour-enchanter-po">Prix du marché pour enchanter (po)</h2>
