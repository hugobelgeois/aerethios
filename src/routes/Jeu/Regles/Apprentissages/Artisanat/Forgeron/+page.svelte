...
{#snippet peuCommuns()}
	<section>
		<h3 id="peu-communs">Peu communs</h3>
...
{#snippet lgendaires()}
	<section>
		<h3 id="lgendaires">Légendaires</h3>
...
{#snippet techniqueDeForge()}
	<section>
		<h2 id="technique-de-forge">Technique de forge</h2>
	{@html renderMarkdown("\n- Damassé")}
