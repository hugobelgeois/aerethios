<script lang="ts">
  ...
  tocHeadings.set([
      ...
      {
          "id": "prix-indicatifs-pa",
          "text": "Prix indicatifs (pa)",
          "level": 3
      },
      {
          "id": "rcolte",
...
{#snippet artificier()}
	<section>
		<h3 id="artificier"><span class="wiki-unresolved">Artificier</span></h3>
...
{#snippet bijoutier()}
	<section>
		<h3 id="bijoutier"><span class="wiki-unresolved">Bijoutier</span></h3>
...
{#snippet tanneur()}
	<section>
		<h3 id="tanneur"><span class="wiki-unresolved">Tanneur</span></h3>
...
{#snippet fabrication()}
	...
	{@render prixIndicatifsPa()}
	</section>
{/snippet}

{#snippet raffinage()}
	<section>
		<h3 id="raffinage">Raffinage</h3>
...
{#snippet prixIndicatifsPa()}
	<section>
		<h3 id="prix-indicatifs-pa">Prix indicatifs (pa)</h3>
