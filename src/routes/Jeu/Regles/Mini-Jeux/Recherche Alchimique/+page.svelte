...
{#snippet slectionDesIngrdients()}
	<section>
		<h2 id="slection-des-ingrdients">Sélection des ingrédients</h2>
...
{#snippet spcialInvocateur()}
	<section>
		<h2 id="spcial-invocateur">Spécial Invocateur</h2>
...
{#snippet modificateursSupplmentaires()}
	<section>
		<h2 id="modificateurs-supplmentaires">Modificateurs supplémentaires</h2>
