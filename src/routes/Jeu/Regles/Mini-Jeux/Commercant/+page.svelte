...
{#snippet dpensesSupplmentaires()}
	<section>
		<h2 id="dpenses-supplmentaires">Dépenses supplémentaires</h2>
...
{#snippet mainDuvre()}
	<section>
		<h3 id="main-duvre">Main-d'œuvre</h3>
...
{#snippet paiementsRguliers()}
	<section>
		<h3 id="paiements-rguliers">Paiements réguliers</h3>
